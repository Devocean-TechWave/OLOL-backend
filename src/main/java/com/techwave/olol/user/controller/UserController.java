...
import com.techwave.olol.user.dto.UserIdInfoDto;
...
public class UserController {
	...
	public ResponseEntity<UserIdInfoDto> joinKakao(
		Authentication authentication,
		@RequestBody @Valid KakaoJoinRequestDto request) {
		UserDetails userDetails = (UserDetails)authentication.getPrincipal();
		return ResponseEntity.ok(new UserIdInfoDto(userService.kakaoJoin(userDetails.getUsername(), request)));
	}
