...
class FriendServiceTest {
	...
	void getFriendRequestTest2() {
		...
		when(userRelationShipRepository.findAllByReceiverId("1")).thenReturn(Collections.singletonList(relationship));
		// when
		FriendReqListDto friendRequest = friendService.getFriendRequest("1");
		// then
	...
	void getSentFriendRequestTest() {
		// given
		when(userRelationShipRepository.findAllBySenderId("1")).thenReturn(Collections.emptyList());
		// when
	...
	void getSentFriendRequestTest2() {
		...
		when(userRelationShipRepository.findAllBySenderId("1")).thenReturn(Collections.singletonList(relationship));
		// when
		FriendReqListDto friendRequest = friendService.getSentFriendRequest("1");
		// then
		assertThat(friendRequest.getFriendReqList()).isNotEmpty();
